...
59 tests in total: 20 end-to-end integration tests against the
...
|---|---|---|
| `ci.yml` | Native build + all unit/integration tests on Linux/macOS/Windows, MSRV verification on Linux, `i686-pc-windows-gnu` cross-compile via Zig, formatting, Clippy, and generated-artifact drift checks. | every push, every PR |
